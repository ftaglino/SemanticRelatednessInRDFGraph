...
public class Constants {
	...
	public static final String SPARQL_DBPEDIA_ENDPOINT = "http://dbpedia.org/sparql";
	...
	public static final String NOT_DIRECTED_PATH = "NO_DIRECTED_PATH";
	...
	public static final String METHOD_REWORD_COMPLETE = "METHOD_REWORD_COMPLETE";
	
	public static final String METHOD_PROXIMITY = "METHOD_PROXIMITY";
	...
	public static final String METHOD_LDSD_ALPHA = "METHOD_LDSD_ALPHA";
	public static final String METHOD_LDSD_BETA = "METHOD_LDSD_BETA";
	public static final String METHOD_LDSD_GAMMA = "METHOD_LDSD_GAMMA";
