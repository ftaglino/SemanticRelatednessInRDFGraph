...
public class ACMDataImport {
	...
	public void generateWeightFiles(String in_file, String out_cf, String out_af, String out_td, String out_iic, String out_rnd) {
		try {
        	...
        	Utils.print(out_cf, cf, false);
        	Utils.print(out_af, af, false);
        	Utils.print(out_td, td, false);
        	Utils.print(out_iic, iic, false);
        	Utils.print(out_rnd, rnd, false);
            b.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
	...
	public void generateAVsFile(String in_annot_file, String out_annot_file) {
		...
		try {
            ...
            b.close();
            Utils.print(out_annot_file, out, false);
        } catch (IOException e) {
            e.printStackTrace();
        }
	}
