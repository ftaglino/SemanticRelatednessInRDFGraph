 ...
 *
 */
public class RDFGraphImpl extends RDFGraph_Endpoint {
	private static RDFGraphImpl instance = null;

	private RDFGraphImpl() {
		super();
		this.load_p_filters();
	...
	public synchronized static RDFGraphImpl getInstance(){
    	if (instance == null){
    		instance = new RDFGraphImpl();
    	}
    	return instance;
    }
	...
	private void load_so_filters() {
		...
		f1.setValue(Filter.generateFilterOut_isLiteral("%%var%%"));
